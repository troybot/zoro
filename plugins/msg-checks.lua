...
if tonumber(msg.via_bot_user_id_) ~= 0 and mute_inline == "✔️" then -- قفل الانلاين
del_msg(chat, tonumber(msg.id))
...
elseif msg.text == "[unsupported]" and mute_video == "✔️" then -- قفل الفيديو
del_msg(chat, tonumber(msg.id))
 if lock_woring == "✔️" then
...
elseif msg.reply_markup_ and  msg.reply_markup_.ID == "ReplyMarkupInlineKeyboard" and mute_keyboard == "✔️" then -- كيبورد
del_msg(chat, tonumber(msg.id))
if lock_woring == "✔️" then
